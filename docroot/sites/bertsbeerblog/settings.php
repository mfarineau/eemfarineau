...
if (file_exists('/var/www/site-php')) {
  require('/var/www/site-php/eemfarineau/eemfarineau-settings.inc');
}

// <DDSETTINGS>
// Please don't edit anything between <DDSETTINGS> tags.
// This section is autogenerated by Acquia Dev Desktop.
if (isset($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR']) && file_exists($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/cld_prod_eemfarineau_dev_default.inc')) {
  require $_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/cld_prod_eemfarineau_dev_default.inc';
}
// </DDSETTINGS>
iif (file_exists('/var/www/site-php')) {
